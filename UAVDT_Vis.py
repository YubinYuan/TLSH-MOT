...
if __name__ == '__main__':
    video_path = r'J:\OpenDataLab___UAVDT\raw\UAV-benchmark-M\M0402'  # 视频帧所在文件夹
    gt_path = r'J:\OpenDataLab___UAVDT\raw\UAV-benchmark-MOTD_v1.0\GT\M0402_gt.txt'          # ground truth文件路径
    output_dir = r'J:\OpenDataLab___UAVDT\raw\hhh\M0402'       # 输出文件夹
